...
Дальше надо подготовить наш импровизированный сервер (в виде вашего компьютера на котором запущен докер с приложением (далее просто "ваш локальный сервер")) к работе и так сказать обслуживанию клиентов в пределах вашей локальной сети (в продакшине вы просто поменяете ip.вашего.локального.сервера на полученный домен (вам все равно придется его получить, поскольку именно для доменов удостоверяющие центры готовы выдавать сертификаты, причем домены какого-нибудь 3го уровня вполне лего можно получить бесплатно))
